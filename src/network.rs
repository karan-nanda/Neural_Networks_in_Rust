...
impl Network<'_> {
    ...
    pub fn save(&self, file:String) {
        let mut file = File::create(file).expect("Unable to reach save file");
        ...
        file.write_all(
            ...
            ).expect("Unable to write to the save file");
    }
    ...
    pub fn load(&mut self, file: String) {
        ...
        let save_data: SaveData = from_str(&buffer).expect("Unable to serialize the save data");
